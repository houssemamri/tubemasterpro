		...
		if ($('.target_checkbox:checked').length > 1) {
			...
			$('.target_checkbox:checked').each(function(y, val){
	            ...
	            $.each(ytdata,function(key,value){
		            ...
		            var target_details_content = "<tr class=\"table-data\"> <td>Add</td> <td>Youtube video</td> <td>Enabled</td> <td>https://www.youtube.com/watch?v="+value['ytid']+"</td> <td>"+targetgroupname+" - Group "+index+"</td> <td>#N/A</td> <td colspan=\"50\"></td> </tr>";
