(function ( $ ) {
    ...
    $.fn.validify = function( options ) {
       ...
       //var base_url = "http://www.myvideoads.dev/";
        ...
        function check ( obj ) {
	        if ( $(obj).is('input[type="text"], textarea') && $(obj).val() != '' ) {
	        	...
	        	if ( $(obj).hasClass('validify_email_ajax') ) {
			        var email_regex = /^(([a-z0-9\+_\-]{1,})+)(\.([a-z0-9\+_\-]{2,})+)*@(([a-z0-9\-]{2,})+\.)+[a-z]{2,6}$/i;
		        ...
		        if ( $(obj).hasClass('validify_twitter') ) {
			        var twitter_regex = /^(http:\/\/twitter.com\/|https:\/\/twitter.com\/)[a-zA-Z0-9. ]+$/;
