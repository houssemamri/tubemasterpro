...
c}var s=function(){},f=s.prototype,l=10,u=1,w="https://gdata.youtube.com/feeds/api/videos";MostPopular="https://gdata.youtube.com/feeds/api/standardfeeds/most_popular";MostRecent="https://gdata.youtube.com/feeds/api/standardfeeds/most_recent";TopRated="https://gdata.youtube.com/feeds/api/standardfeeds/top_rated";TopFavs="https://gdata.youtube.com/feeds/api/standardfeeds/top_favorites";RecentlyFeatured="https://gdata.youtube.com/feeds/api/standardfeeds/recently_featured";SuggestURL="https://suggestqueries.google.com/complete/search";
...
function(){return OrderBy};f.suggest=function(a,b){a={q:encodeURIComponent(a)};var c=m(SuggestURL,h.extend({},t,a));h.ajax({type:"GET",dataType:"json",url:c,success:function(d){var g=[],e={};for(entry in d[1])g.push(d[1][entry][0]);e.suggestions=g;e.searchURL=c;typeof b=="function"&&b(e)}})};f.search=function(a,b){if(typeof a=="string")a={q:encodeURIComponent(a)};return v(h.extend({},k,a),b)};f.video=function(a,b){return n("https://gdata.youtube.com/feeds/api/videos/"+a+"?alt=json",b)};f.mostViewed=
function(a,b){return i("https://gdata.youtube.com/feeds/api/standardfeeds/most_viewed",j(a,true),b)};f.mostRecent=function(a,b){return i(MostRecent,j(a,false),b)};f.mostPopular=function(a,b){return i(MostPopular,j(a,true),b)};f.topRated=function(a,b){return i(TopRated,j(a,true),b)};f.topFavs=function(a,b){return i(TopFavs,j(a,true),b)};var q=function(a){var b=[],c=a.id.$t,d=c.lastIndexOf("/")+1;this.videoId=c.substring(d,c.length);this.title=a.title.$t;try{this.updated=a.updated.$t}catch(g){b.push("updated")}try{this.thumbs=
