...
myValidate();
$('#file_name, #video_ads, #mobile_bid_mdifier, #language, #countries, #display_url, #destination_url').change(myValidate);	
$('#video_ads').hide();
...
*/
	...
	function SaveCampaign ( el, exported ) {
	...
	$('#saveCampaign').bind('click', function(){
		SaveCampaign($(this), false);
	});

	$('#btnExportCSV').bind('click', function(){
		var saved = SaveCampaign($('#saveCampaign'), this);
		if (saved) {
