$(document).ready(function(){
	...
	var base_url = 'https://www.tubemasterpro.com/';
...
*/
	...
	function reset_tour () {
		$.ajax({
			url: 'https://www.tubemasterpro.com/dashboard/dashboard_ajax/reset_tour',
			type: "POST"
		});
                    		...
                    		if ( $('#keywords_table tbody tr').length > 0 ) {
                        		...
                        		$('#hook-five a.channel_key_search').on('click', function(e){
									...
									request.done(function(msg){
										window.location.href = base_url + 'dashboard/channel_search?keyword='+keyword;
									});
								});
	        ...
	        tours : [
	            {
	                ...
	                onEndTour          : function(ui){
	                	$.ajax({
							url: base_url + 'dashboard/dashboard_ajax/update_tour',
							type: "POST",
							data: {
								status : 1
							}
	                    ...
	                    },
	                    {
	                        ...
	                        onShowStep      : function(ui){
	                            ...
	                            $('.video_key_search').on('click', function(e){
									...
									request.done(function(msg){
										window.location.href = base_url + 'dashboard/video_search?keyword='+keyword;
									});
								});
