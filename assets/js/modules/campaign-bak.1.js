...
*/
	...
	$('#btnExportCSV').bind('click', function(){
		...
		$('.target_checkbox:checked').each(function(y, val){
			...
			var target_tg_content = "<tr class=\"table-data\"> <td>Add</td> <td>Enabled</td> <td>"+targeting_group+"_"+y+"</td> <td>"+filename+"</td> <td>"+max_cpv+"</td> <td colspan=\"50\"></td></tr>";
			...
			for(i=0;i<video_ads.length;i++){
				...
				if(video_ads[i]!=null){	
					...
					var target_ads_content = "<tr class=\"table-data\"> <td>Add</td> <td>Enabled</td> <td>"+$(video_ads_option[i]).data('title')+"</td> <td>"+video_ads[i]+"</td> <td> default</td> <td>#N/A</td> <td> #N/A </td> <td>#N/A</td> <td>"+disp_url+"</td> <td>"+dest_url+"</td> <td>#N/A</td> <td>in-stream</td> <td>#N/A</td> <td>"+targeting_group+"_"+y+"</td> <td>"+filename+"</td> <td colspan=\"41\"></td></tr>";
			...
			for(i=0;i<gender.length;i++){
				...
				if(gender[i]!=null){
					...
					var target_g_content = "<tr class=\"table-data\"> <td>Add</td> <td>Gender</td> <td>Enabled</td> <td> "+$(gender[i]).val()+"</td> <td>"+targeting_group+"_"+y+"</td> <td align= 'center'> #N/A </td> <td colspan=\"50\"></td> </tr>";
		...
		//Age Loop
			for(i=0;i<age.length;i++){
				...
				if(age[i]!=null){
						...
						var target_a_content = "<tr class=\"table-data\"> <td>Add</td> <td>Age</td> <td>Enabled</td> <td> "+$(age[i]).val()+"</td> <td>"+targeting_group+"_"+y+"</td> <td align= 'center'> #N/A </td> <td colspan=\"50\"> </td> </tr>";
            ...
            $.each(ytdata,function(key,value){
	            ...
	            var target_details_content = "<tr class=\"table-data\"> <td>Add</td> <td>Youtube video</td> <td>Enabled</td> <td>https://www.youtube.com/watch?v="+value['ytid']+"</td> <td>"+targeting_group+"_"+y+"</td> <td>#N/A</td> <td colspan=\"50\"></td> </tr>";
