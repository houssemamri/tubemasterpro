...
==================================================================== */
$('.tweet').twittie({
    apiPath : 'assets/main/assets/js/plugins/twitter/api/tweet.php',
    count: 2,
...
$(".mailchimp-subscribe").ajaxChimp({
    ...
    url: "//australiawow.us5.list-manage.com/subscribe/post?u=fafdef4aa1c4ef81b83774210&amp;id=dfbe0a662b" // Replace your mailchimp post url inside double quote "".  
});
...
/* ===========================================================
   PREVENT LOAD OF VIDEO BACKGROUND WHEN IN MOBILE PORTRAIT  
============================================================== */
// if($('header.video-bg video').length == 0) {
//  $('header.video-bg').css({'background':'url(../assets/images/main_page_bg.png) center center'});
// }
