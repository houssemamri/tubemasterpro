...
<html lang="en">
    <head>
        ...
        <title>Upload video review</title>
        <meta name="description" content="Upload video review">
...
<div class="container">
  ...
  <h3>Upload video review</h3>      
  <div id="notification"></div>
  <p>Valid format: *.mp4, *.avi</p>
<p><input type="file" name="afile" id="afile" accept=".mp4, .avi"/></p> 
<p><button name="send" type="button" class="btn btn-danger" id="back_to_review">Back</button> <button name="send" type="submit" class="btn btn-primary" id="submit_upload_video">Submit</button></p>
</form>
        </div>
    </div> <!-- /row -->
</div> <!-- /container -->
