        ...
        if ( $campaign_list ) {
	        ...
	        foreach ($campaign_list as $key => $value) {
	        	...
	        	if ($uploaded) {
	                ...
	                $campaigns .= '<p>';
	                $campaigns .= '<button data-cid="'.$value->id.'" type="button" class="btn btn-warning btn-xs btn-info"><span class="glyphicon glyphicon-info-sign"></span> Info</button> ';
	                $campaigns .= '<button data-cid="'.$value->id.'" type="button" class="btn btn-success btn-xs btn-upload"><span class="glyphicon glyphicon-upload"></span> Update</button>';
	                $campaigns .= '</p>';
	                $campaigns .= '</td>';
					$campaigns .= '</tr>';
	        	}
	        		...
	        		$campaigns .= '<tr>';
	                $campaigns .= '<td>'.$value->name.'</td>';
	                $campaigns .= '<td>No Data Uploaded Yet</td>';
	                $campaigns .= '<td class="text-center">';
	                $campaigns .= '<p>';
	                $campaigns .= '<button data-cid="'.$value->id.'" type="button" class="btn btn-warning btn-xs btn-info"><span class="glyphicon glyphicon-info-sign"></span> Info</button> ';
	                $campaigns .= '<button data-cid="'.$value->id.'" type="button" class="btn btn-primary btn-xs btn-upload"><span class="glyphicon glyphicon-upload"></span> Upload</button>';
	                $campaigns .= '</p>';
	                $campaigns .= '</td>';
					$campaigns .= '</tr>';
	        	}
