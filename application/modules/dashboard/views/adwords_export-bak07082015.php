    ...
    <div class="col-sm-12">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7" id="hook-fifteen">
              <input class="form-control" id="destination_url" name="destination_url" type="text" placeholder="Enter URL">
          </div>
      </div>
  ...
  <div id="csv_table" style="display:none">
    ...
    <div class="col-sm-12">
      <div class="form-group" id="hook-eightteen">
        ...
        <a class="btn btn-success btn-lg" type="button" id="saveCampaign" data-action="<?php echo site_url('dashboard/campaign_ajax'); ?>">Save Campaign</a>
      </div>
    </div> 
</form>
