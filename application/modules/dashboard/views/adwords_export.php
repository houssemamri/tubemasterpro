...
padding-left: 10px;border-radius:5px;border:medium solid #a94442;">
                  <?php if($targets){
                        echo $targets;
                  }?>
              </ul>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3">
              <input class="form-control" id="max_cpv" name="max_cpv" type="text" placeholder="" value="0.10">
        </div>
      </div>
    </div>
    <div class="col-sm-6">
...
<div class="modal fade" id="date_today_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center;">
          <p>
            Set your campaign date to be TODAY in "Show Advanced Campaign Options"
          </p>
      </div>
...
<div class="modal fade" id="first_export" data-backdrop="static" data-keyboard="false"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">

    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title text-center" id="myModalLabel">CONGRATULATIONS!</h4>
      </div>
      <div class="modal-body" style="text-align:center;">
          <p>
           You now are eligible to use our Automated Campaign Optimizer feature (sweet!)
<br />
It will appear on the left hand side menu - see YouTube University too, so you can see how to use this new POWERFUL feature
          </p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" id="first_export_reload">Ok</button>
      </div>
    </div>
  </div>
</div>
